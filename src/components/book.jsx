...
import { getID } from '../redux/putSlicer'
...
export default function Book({ props }) {
    ...
    function getUpdatedBookId() {
        console.log('getUpdatedBookId function activated');
        dispatch(getID(_id))
    }
    ...
    return (
        <li className="bg-custom-brown flex flex-col items-center justify-center gap-6 p-4 rounded-md">
            ...
            <div className="functions flex w-full justify-between ">
                ...
                <NavLink to={ '/updateBook'} state={{id:_id}} className="updateBtn text-center w-1/2">update</NavLink>
            </div>
        </li>
    )
}